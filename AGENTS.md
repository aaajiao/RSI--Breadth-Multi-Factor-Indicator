...
- Smart alerts should publish from the current visible trigger level on that tick; do not delay-fire from stale intrabar max levels after the visible trigger path has faded.
